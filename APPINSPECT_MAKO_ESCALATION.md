...
REST Profiler 1.0.1 is generated with Splunk UCC Framework 6.5.3. The generated file
...
Expected current result: AppInspect exits with code 104 and reports one
`future_failure` for `appserver/templates/base.html`.

## Suggested support message

Subject: UCC 6.5.3-generated static base.html is flagged by AppInspect 4.3.0

REST Profiler for Splunk 1.0.1 is generated with
